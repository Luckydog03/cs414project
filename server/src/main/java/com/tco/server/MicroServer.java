...
import com.tco.requests.RegisterRequest;
...
import com.tco.requests.ReadMatchRequest;
import com.tco.requests.ReadGameboardRequest;
import com.tco.requests.UpdateGameboardRequest;
import com.tco.requests.ReadUserRequest;
...
public final class MicroServer {
    ...
    private void processRestfulAPIrequests() {
        path("/api", () -> {
            ...
            post("/readinvite", (req, res) -> processHttpRequest(req, res, ReadInviteRequest.class));
            post("/acceptinvite", (req, res) -> processHttpRequest(req, res, AcceptInviteRequest.class));
            post("/rejectinvite", (req, res) -> processHttpRequest(req, res, RejectInviteRequest.class));
            post("/readmatch", (req, res) -> processHttpRequest(req, res, ReadMatchRequest.class));
            post("/readuser", (req, res) -> processHttpRequest(req, res, ReadUserRequest.class));
            post("/readgameboard", (req, res) -> processHttpRequest(req, res, ReadGameboardRequest.class));
            post("/updategameboard", (req, res) -> processHttpRequest(req, res, UpdateGameboardRequest.class));
        });
    }
